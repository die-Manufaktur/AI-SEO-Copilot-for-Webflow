...
(() => {
  ...
  // .wrangler/tmp/bundle-5UrHwt/checked-fetch.js
...
`
  ...
  // .wrangler/tmp/bundle-5UrHwt/middleware-insertion-facade.js
...
${nonMinifiedJs.slice(0, 5).join("\n")}`;
          if (nonMinifiedJs.length > 5) {
            minificationRecommendation += `
...and ${nonMinifiedJs.length - 5} more`;
          }
        }
...
${nonMinifiedCss.slice(0, 5).join("\n")}`;
          if (nonMinifiedCss.length > 5) {
            minificationRecommendation += `
...and ${nonMinifiedCss.length - 5} more`;
          }
        }
